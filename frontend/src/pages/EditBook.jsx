...
const EditBook = () => {
  ...
  return (
    <div className='min-h-screen p-6 bg-slate-900'>
      ...
      {loading ? <Spinner /> : ''}
      <div className='flex flex-col border-2 border-sky-400 rounded-x1 w-[600px] p-4 mx-auto rounded-md'>
        <div className='my-4'>
        ...
        <button className='p-2 bg-sky-800 text-white my-7 rounded-md w-120' onClick={handleEditBook}>
          Save
        </button>
      </div>
    </div>
